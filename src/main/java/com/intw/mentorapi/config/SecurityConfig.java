    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .and()
                ...
                .antMatchers(HttpMethod.POST, "/app/auth").permitAll()
                .antMatchers(HttpMethod.POST, "/app/comment").hasAnyRole("ADMIN", "MANAGER", "USER")
                .antMatchers(HttpMethod.PUT, "/app/comment").hasAnyRole("ADMIN", "MANAGER", "USER")
                .antMatchers(HttpMethod.DELETE, "/app/comment").hasAnyRole("ADMIN", "MANAGER", "USER")
